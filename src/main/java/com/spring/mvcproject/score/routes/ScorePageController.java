...
public class ScorePageController {
    ...
    public String scorePage(Model model) {
        // 해당 JSP 파일의 경로를 적음
        model.addAttribute("title","성적관리");
        model.addAttribute("foods", List.of("짜장","떡볶이","순대"));
...
//        // 해당 JSP 파일의 경로를 적음
//        mv.addObject("title","성적관리");
//        mv.addObject("foods", List.of("짜장","떡볶이","순대"));
